namespace WaterTestStation
{
	partial class ViewResultsForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.rptDataSet = new Microsoft.VisualBasic.PowerPacks.DataRepeater();
			...
			this.tableLayoutPanel2.Controls.Add(this.lbtnAddDataSet, 0, 6);
			this.tableLayoutPanel2.Controls.Add(this.rptDataSet, 0, 7);
			...
			this.lbtnAddDataSet.Location = new System.Drawing.Point(3, 125);
			this.lbtnAddDataSet.Name = "lbtnAddDataSet";
			this.lbtnAddDataSet.Size = new System.Drawing.Size(92, 17);
			this.lbtnAddDataSet.TabIndex = 5;
			this.lbtnAddDataSet.TabStop = true;
			this.lbtnAddDataSet.Text = "Add Data Set";
			...
			// rptDataSet
			// 
			this.rptDataSet.Dock = System.Windows.Forms.DockStyle.Fill;
			// 
			// rptDataSet.ItemTemplate
			// 
			this.rptDataSet.ItemTemplate.Size = new System.Drawing.Size(350, 100);
			this.rptDataSet.Location = new System.Drawing.Point(3, 148);
			this.rptDataSet.Name = "rptDataSet";
			this.rptDataSet.Size = new System.Drawing.Size(358, 375);
			this.rptDataSet.TabIndex = 6;
			this.rptDataSet.Text = "dataRepeater1";
			// 
			// dgvDataGrid
			// 
			...
			this.rptDataSet.ResumeLayout(false);
		...
		private Microsoft.VisualBasic.PowerPacks.DataRepeater rptDataSet;
